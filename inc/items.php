    ...
    ?>
        ...
        <h3 class="bg-success text-light rounded text-center"><?php echo $item['Name']?></h3>
            ...
            <div class="card-body">
                ...
                <p class="card-text"><?php echo substr($item['Description'],0,180).'...'?></p>
                <div class="row">
                    <a href="<?php echo $pages?>/items/itemDetails.php?id=<?php echo $item['Id']?>" class="btn btn-primary col-md-6 fw-bold">show detials</a>
