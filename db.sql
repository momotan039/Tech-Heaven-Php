...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4132578576ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="248">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=categories">`test`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=products">`test`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=category">`test`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=orders">`test`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=users">`test`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpress&table=wp_users">`wordpress`.`wp_users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=f">`test`.`f`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=ff3">`test`.`ff3`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=&table=users">``.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=ff2">`test`.`ff2`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4e5a596140465e5177286d39783a6c78">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="248"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="test" targettable="products">
...
INNER JOIN categories on CatId=categories.Id;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test" targettable="products">
                            <div class="action_content">
...
on CatId=categories.Id;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test" targettable="categories">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT categories.Name FROM `products` 
INNER JOIN categories
on CatId=categories.Id;</span>
                        </div>
                                            <div class="message history collapsed hide select"
            ...
            Queried time
                            ...
                            <span class="query">SELECT `Cat_Description` FROM `categories` WHERE `categories`.`Id` = 2</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test" targettable="products">
                            <div class="action_content">
...
on CatId=categories.Id;</span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT cat_description FROM `products` 
INNER JOIN categories
on CatId=categories.Id;</span>
                        </div>
                                            <div class="message history collapsed hide select"
            ...
            Queried time
                            ...
                            <span class="query">SELECT Description FROM `products` 
INNER JOIN categories
on CatId=categories.Id;</span>
                        </div>
                                            <div class="message history collapsed hide select"
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products` WHERE 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT Description FROM `products` WHERE 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT `Description` FROM `products` WHERE `products`.`Description` = &#039;The iPhone 13 Pro is a flagship smartphone that redefines mobile technology. With a stunning Super Retina XDR display, a powerful A15 Bionic chip, and advanced camera capabilities, this device offers an unparalleled user experience. Stay connected with 5G connectivity and enjoy a range of features that make the iPhone 13 Pro a true technological marvel.&#039;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM products INNER JOIN categories on CatId=categories.Id;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test" targettable="categories">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM products INNER JOIN categories on CatId=categories.Cat_Id;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test" targettable="categories">
                            <div class="action_content">
